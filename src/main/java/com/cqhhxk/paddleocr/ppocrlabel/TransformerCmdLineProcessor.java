...
public class TransformerCmdLineProcessor {
    ...
    private static void printUsage() {
        ...
        System.out.println("  java -jar " + jarName + " --image-dir <PPOCRLabel cropped image folder> --label-file <original PPOCRLabel label file> [--width <New canvas width (px)> --height <New canvas height (px)> --output-dir <Folder to save modified images>]");
        System.out.println();
    }
}
